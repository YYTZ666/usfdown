export const files = [
    ...
    {
         name: "USF0.7.20B",
         description: "添加记分板管理功能，修复部分bug",
         changelog:
        ["1.添加了收到转账时提示转账玩家 (GH#90)",
"2.修复了管理员创建领地不扣费的问题(GH#89)", 
"3.删除记分板默认值按钮，添加记分板管理功能（注：默认值得重新设置），改了部分错字",
     ...
     },
    {
     ...
     },
     {
        ...
        [
         ...
         supportVersions: ["1.21.90","1.21.92","1.21.93","1.21.94"],
        ...
        {
         name: "USF0.7.9S",
         description: "修复了小木斧替换功能无法使用的bug",
         changelog: [
                 "修复了小木斧替换功能无法使用的bug" 
         ],
         contributors: [
        ...
        {
         name: "USF0.7.8",
         description: "适配1.21.9x，修复了部分ui界面异常的问题，修复了小木斧无法使用的bug",
         changelog: [
                 "修复了部分ui界面异常的问题",
             "修复了小木斧无法使用的bug"
         ],
